...
wcl386 -zdp -wcd=138 -ecc -4s -mf -fp3 -za -bt=dos -l=dos32a src/io/timer.c -c -fo=obj/timer.obj
wcl386 -zdp -wcd=138 -ecc -4s -mf -fp3 -za -bt=dos -l=dos32a src/io/keyboard.c -c -fo=obj/keyboard.obj
wcl386 -zdp -wcd=138 -ecc -4s -mf -fp3 -za -bt=dos -l=dos32a src/io/bitmap.c -c -fo=obj/bitmap.obj
